...
public class PostIntegrationTests {
    ...
    public void testShowAd() throws Exception {
        ...
        this.mvc.perform(get("/ads/" + existingAd.getId()))
                ...
                .andExpect((ResultMatcher) content().string(containsString(existingAd.getBody())));
    }
    ...
    public void testAdsIndex() throws Exception {
        ...
        this.mvc.perform(get("/ads"))
                ...
                .andExpect((ResultMatcher) content().string(containsString("Latest posts")))
                // Test the dynamic content of the page
    ...
    public void testEditAd() throws Exception {
        ...
        this.mvc.perform(get("/ads/" + existingAd.getId()))
                .andExpect(status().isOk())
                // Test the dynamic content of the page
                .andExpect((ResultMatcher) content().string(containsString("edited title")))
                .andExpect((ResultMatcher) content().string(containsString("edited description")));
    }
